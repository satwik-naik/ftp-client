        ...
        <form onSubmit={handleSubmit}>
          <div className="mt-4">
            ...
            <input type="text" placeholder="Username" 
              ...
              name="username" id="username" onChange={(e)=>{
          ...
          <div className="mt-4">
            ...
            <input type="email" placeholder="Email" 
              className="clearIN w-full px-4 py-2 mt-2 rounded-md focus:outline-none focus:ring-1 border-2 border-blue-600"
              name="email" id="email" onChange={(e)=>{
          ...
          <div className="mt-4">
            ...
            <input type="password" placeholder="Password" 
              className="clearIN w-full px-4 py-2 mt-2 rounded-md focus:outline-none focus:ring-1 border-2 border-blue-600"
              name="password" id="password" onChange={(e)=>{
          ...
          <div className="mt-4">
            ...
            <input type="password" placeholder="Confirm Password" 
              className="clearIN w-full px-4 py-2 mt-2  rounded-md focus:outline-none focus:ring-1 border-2 border-blue-600"
              name="confirmPassword" id="confirmPassword" onChange={(e)=>{
                setConfirmPassword(e.target.value)
              }} required
            />
          </div>
          <div className="flex items-baseline justify-between my-4">
            <button className="px-8 py-2 mt-4 text-white bg-black rounded-lg hover:bg-red-500" >Register</button>
            <a href="/login" className="text-sm text-blue-700 hover:underline" >already registered</a>
          </div>
        </form>
      </div>
    </div>
